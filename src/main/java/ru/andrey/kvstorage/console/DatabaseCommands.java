...
public enum DatabaseCommands {
    CREATE_DATABASE {
        ...
        public DatabaseCommand getCommand(ExecutionEnvironment environment, String... args) throws DatabaseException {
            if (args.length != 1) {
                throw new DatabaseException("Command requires 1 arguments, not " + (args.length - 1) + " arguments");
            }
    ...
    CREATE_TABLE {
        ...
        public DatabaseCommand getCommand(ExecutionEnvironment environment, String... args) throws DatabaseException {
            if (args.length != 2) {
                throw new DatabaseException("Command requires 2 arguments, not " + (args.length - 1) + " arguments");
            }
    ...
    UPDATE_KEY {
        ...
        public DatabaseCommand getCommand(ExecutionEnvironment environment, String... args) throws DatabaseException {
            if (args.length != 4) {
                throw new DatabaseException("Command requires 4 arguments, not " + (args.length - 1) + " arguments");
            }
    ...
    READ_KEY {
        ...
        public DatabaseCommand getCommand(ExecutionEnvironment environment, String... args) throws DatabaseException {
            if (args.length != 3) {
                throw new DatabaseException("Command requires 3 arguments, not " + (args.length - 1) + " arguments");
            }
